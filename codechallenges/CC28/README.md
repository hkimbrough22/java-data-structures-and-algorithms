# Library
## Quick Sort
[comment]: <> (resource given by Ed for understanding QuickSort:)
[comment]: <> (https://runestone.academy/runestone/books/published/pythonds/SortSearch/TheQuickSort.html)
